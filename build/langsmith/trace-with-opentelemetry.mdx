...
If you're sending traces to LangSmith via OpenTelemetry, configure your spans so the [Messages view](/langsmith/view-traces#messages-view) can render your traces correctly. Two things are required:
