...
<Note>
**LangSmith Cloud (SaaS) only.** The Remote MCP is available on all LangSmith Cloud regions (`api.smith.langchain.com`, `eu.api.smith.langchain.com`, `aws.api.smith.langchain.com`, and `apac.api.smith.langchain.com`). [Self-hosted LangSmith](/langsmith/self-hosted) deployments should continue to use the [standalone LangSmith MCP Server](/langsmith/langsmith-mcp-server).
</Note>
