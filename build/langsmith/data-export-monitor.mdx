...
<Note>
**For self-hosted, EU (GCP), US (AWS), and APAC (GCP) SaaS**

Update the LangSmith URL in the requests below for self-hosted installs, EU (GCP) (`eu.api.smith.langchain.com`), US (AWS) (`aws.api.smith.langchain.com`), or APAC (GCP) (`apac.api.smith.langchain.com`).
</Note>
