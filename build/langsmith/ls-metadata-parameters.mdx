...
**What it does:**
Controls how messages from custom agent-like runs appear in the [Messages view](/langsmith/view-trace#messages-view).
...
For more details, see [Customize the Messages view](/langsmith/view-trace#customize-the-messages-view).
