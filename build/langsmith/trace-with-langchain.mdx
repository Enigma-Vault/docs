...
client = ls.Client(
    ...
    api_url="https://api.smith.langchain.com",  # Self-hosted, EU (GCP) (`eu.api...`), US (AWS) (`aws.api...`), or APAC (GCP) (`apac.api...`) as needed
)
...
const client = new Client(
    {
        apiKey: "YOUR_API_KEY",
        apiUrl: "https://api.smith.langchain.com", // Self-hosted, EU (GCP) (`eu.api...`), US (AWS) (`aws.api...`), or APAC (GCP) (`apac.api...`) as needed
    }
);
