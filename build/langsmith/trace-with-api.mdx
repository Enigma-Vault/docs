...
def post_run(run_id, name, run_type, inputs, parent_id=None):
    ...
    requests.post(
        "https://api.smith.langchain.com/runs",  # Update for self-hosted, EU (GCP) (`eu.api...`), US (AWS) (`aws.api...`), or APAC (GCP) (`apac.api...`)
        json=data,
        headers=headers
    )
...
api_url = "https://api.smith.langchain.com"  # EU (GCP): eu.api...; US (AWS): aws.api...; APAC (GCP): apac.api... for regional SaaS
