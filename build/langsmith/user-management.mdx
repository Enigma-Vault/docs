...
1. In your IdP: Configure a SAML application with the following details, then copy the metadata URL or XML for step 3.
   ...
   <Note>
   The following URLs depend on whether your organization is on the US (GCP), EU (GCP), US (AWS), or APAC (GCP) cloud region. Ensure you select the correct link.
   </Note>
   ...
   1. Single sign-on URL (or ACS URL):
      ...
      - APAC (GCP): [https://apac.auth.langchain.com/auth/v1/sso/saml/acs](https://apac.auth.langchain.com/auth/v1/sso/saml/acs)
   2. Audience URI (or SP Entity ID):
      ...
      - APAC (GCP): [https://apac.auth.langchain.com/auth/v1/sso/saml/metadata](https://apac.auth.langchain.com/auth/v1/sso/saml/metadata)
...
1. Fill in `AuthHost`:
    ...
    - APAC (GCP): `apac.auth.langchain.com`
1. (Optional, if planning to use [SCIM](#set-up-scim-for-your-organization) as well) Fill in `LangSmithUrl`:
    ...
    - APAC (GCP): `apac.api.smith.langchain.com`
...
Use the `PATCH /orgs/current/info` [endpoint](https://api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch) (EU (GCP), US (AWS), and APAC (GCP): same path on [`eu.api.smith.langchain.com`](https://eu.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch), [`aws.api.smith.langchain.com`](https://aws.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch), and [`apac.api.smith.langchain.com`](https://apac.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch)):
...
1. Under **Admin Credentials**:
   ...
   - **Tenant URL**:
     ...
     - APAC (GCP): `https://apac.api.smith.langchain.com/scim/v2`
