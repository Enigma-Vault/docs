...
To use features like **human-in-the-loop**, you mute place non-deterministic work (for example, random values) and side effects (for example, file writes or API calls) in [**tasks**](/oss/javascript/langgraph/functional-api#task).
